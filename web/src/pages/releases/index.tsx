                  ...
                  {ls.tileView ? (
                    <div className="flex flex-col h-full">
                      <div className="flex items-start justify-between gap-2">
                        <h3 className="text-sm font-semibold text-foreground truncate">{release.metadata.name}</h3>
                        <Badge variant="secondary" className="shrink-0 text-[11px]">{release.spec.componentVersionRef.name}</Badge>
                      </div>
                      <p className="mt-1 text-xs text-muted-foreground flex-1">{release.metadata.namespace}</p>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-3">
                          <h3 className="text-base font-semibold text-foreground">{release.metadata.name}</h3>
                          <Badge variant="secondary" className="text-[11px]">{release.spec.componentVersionRef.name}</Badge>
                        </div>
                        <p className="mt-0.5 text-sm text-muted-foreground">{release.metadata.namespace}</p>
                      </div>
                    </div>
                  )}
                </div>
