    ...
    <Card className="py-10">
      <CardContent>
        <div className="mx-auto max-w-md text-center">
          ...
          <p className="font-medium text-foreground">No cluster-wide access to {resource}</p>
          <p className="mt-1 text-sm text-muted-foreground">
            Listing {resource} across all namespaces requires cluster-scope RBAC, which your current
            identity doesn't have. Pick a specific namespace from the sidebar to see what you can
            access.
          </p>
        </div>
      </CardContent>
