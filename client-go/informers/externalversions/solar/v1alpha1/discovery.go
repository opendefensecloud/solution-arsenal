...
type DiscoveryInformer interface {
	...
	Lister() solarv1alpha1.DiscoveryLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SolarV1alpha1().Discoveries(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SolarV1alpha1().Discoveries(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options v1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SolarV1alpha1().Discoveries(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SolarV1alpha1().Discoveries(namespace).Watch(ctx, options)
			},
		},
		&apisolarv1alpha1.Discovery{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *discoveryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisolarv1alpha1.Discovery{}, f.defaultInformer)
}

func (f *discoveryInformer) Lister() solarv1alpha1.DiscoveryLister {
	return solarv1alpha1.NewDiscoveryLister(f.Informer().GetIndexer())
}
