...
func (b *ReleaseStatusApplyConfiguration) WithJobRef(value corev1.ObjectReference) *ReleaseStatusApplyConfiguration {
	b.JobRef = &value
	return b
}
...
func (b *ReleaseStatusApplyConfiguration) WithConfigSecretRef(value corev1.ObjectReference) *ReleaseStatusApplyConfiguration {
