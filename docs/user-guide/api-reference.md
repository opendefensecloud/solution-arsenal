...
| `priority` _integer_ | Priority determines which Release takes precedence when multiple Releases<br />share the same unique name on a Target. Higher values indicate higher priority. |  |  |
