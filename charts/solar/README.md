...
- A Helm release whose [supported version skew](https://helm.sh/docs/topics/version_skew/) covers your cluster — Helm 3.18+ for Kubernetes 1.33, Helm 4.2+ for 1.36
