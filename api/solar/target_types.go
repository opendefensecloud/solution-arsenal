...
type TargetStatus struct {
	...
	// PreviousPublicKey is the PEM-encoded cosign public key that was
	// previously active. During key rotation it is kept for a grace period
	// so that in-flight verification does not break.
	// +optional
	PreviousPublicKey string `json:"previousPublicKey,omitempty"`

	// PublicKey is the PEM-encoded cosign public key for this target.
	// It is generated by the target_controller and used by the solar-agent
	// to create a verification Secret on the target cluster. Flux OCIRepository
	// resources reference this key in spec.verify.
	// +optional
